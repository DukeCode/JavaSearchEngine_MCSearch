...
public class InitPath {
	public static String urlPath="init//url//";// folder to store url
	public static String resourcePath="init//resource//";// folder to store response
	public static String contentPath="init//content//";// folder to store content
	public static String parsedTitle = "init//parsedTitle//"; // folder to store parsedTitle
